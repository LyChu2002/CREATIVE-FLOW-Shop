            ...
            <main class="content">
             <div class="row">
                    <div class="col-7 align-self-center">
                        <h2 class="page-title text-truncate text-dark font-weight-medium mb-1">Add New Category</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
	                        	...
	                        	<sf:form class="form" action="${classpath }/admin/category-add-save" method="post" modelAttribute="category" enctype="multipart/form-data">
	                        		 <div class="form-body">
	                        		 	...
	                        		 	<div class="row">
	                                    	...
	                                    	<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="name" type="text" class="form-control" id="name" placeholder="category name"></sf:input>
	                        			...
	                        			<div class="row">
	                        		 		...
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        <label for="password">Update by</label>
										...
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="createDate" type="date" class="form-control" id="createDate" name="createDate"></sf:input>
                                        		</div>
	                                    	</div>
	                                    	
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        <label for="mobile">Update date</label>
			                                        <sf:input path="updateDate" type="date" class="form-control" id="updateDate" name="updateDate"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        <a href="${classpath }/admin/category-list" class="btn btn-light active" role="button" aria-pressed="true">
			                                        	Back to list
			                                        </a>
